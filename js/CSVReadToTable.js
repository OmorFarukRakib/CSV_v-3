    ...
    Papa.parse(csvFileInput.files[0], {
      ...
      complete: (results) => {
        ...
        $(document).ready(function () {
          ...
          // Add serial No
          // var autoID;
          // Validation at first time data set on table
          //$("button#post_add_jichitai_codes_Button").click();
         ...
         // calculateStatusInfo();
          ...
          //     $(this).find("td:nth-child(2)").html(`Undefined`);
          //   } else {
          //     $(this).find("td:nth-child(2)").html(`Empty`);
